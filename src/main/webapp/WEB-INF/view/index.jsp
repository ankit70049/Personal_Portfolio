				...
				<div class="row">
					<div class="col-lg-7">
						<div class="banner_content">
							...
							<h1 class="text-uppercase">I am Ankit Kumar</h1>
							<h5 class="text-uppercase">Java Full Stack Developer</h5>
							<div class="d-flex align-items-center">
								<a class="primary_btn" href="${pageContext.request.contextPath}/client/contact"><span>Hire
										Me</span></a>
								<a class="primary_btn tr-bg" href="${pageContext.request.contextPath}/client/downloadResume"><span>Get
										CV</span></a>
							</div>
						</div>
					</div>
					<div class="col-lg-5">
						<div class="home_right_img">
							<img class="" style="width:550px; height:auto " src="${pageContext.request.contextPath}/profile/profile" alt="">
						</div>
					</div>
				</div>    
			</div>
				...
				<div class="offset-lg-2 col-lg-4 col-md-6">
					<div class="client-info">
						<div class="d-flex mb-50">
							<span class="lage">10</span> <span class="smll">Years
								Experience Working</span>
						</div>
			...
			<%-- 
				 <div class="col-lg-3 col-md-6">
					<div class="feature_item">
						...
						<h4>Wp developing</h4>
						<p>Creeping for female light years that lesser can't evening
			...
			<div class="row justify-content-center">
				<div class="col-lg-8 text-center">
					<div class="main_title">
						...
						<p>
							Is give may shall likeness made yielding spirit a itself togeth
							created after sea is in beast <br> beginning signs open god
							you're gathering ithe
						</p>
					</div>
				</div>
